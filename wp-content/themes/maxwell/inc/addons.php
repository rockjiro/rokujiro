 ...
 */
function maxwell_theme_addons_setup() {

	// Add theme support for Maxwell Pro plugin.
	add_theme_support( 'maxwell-pro' );
	...
	add_theme_support( 'infinite-scroll', array(
		...
		'wrapper'        => false,
		'render'         => 'maxwell_infinite_scroll_render',
		'posts_per_page' => 6,
	) );
 ...
 */
function maxwell_theme_addons_scripts() {
...
add_action( 'wp_enqueue_scripts', 'maxwell_theme_addons_scripts' );
