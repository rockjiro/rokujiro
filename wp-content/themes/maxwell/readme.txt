...
Maxwell is a minimalistic and elegant WordPress theme featuring an ultra clean magazine layout. With a beautiful typography, various post layouts and a gorgeous featured posts slideshow Maxwell truly helps you to stand out.

For more information about Maxwell please go to https://themezee.com/themes/maxwell/

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Maxwell in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to https://themezee.com/docs/maxwell-documentation/ for a guide on how to customize this theme.
...
= 1.0.3 =
* added setting to display tagline
* added content-none.php template file
* added post image template function
* improved accessibility of navigation menus
* improved code formatting with PHP Codesniffer

= 1.0.2 =
* added support for selective refresh
* updated custom logo styling and editor-style.css
* improved styling of lists, tables and blockquotes

= 1.0.1 =
* added support for custom logo feature
* added version numbers to wp_enqueue_style and wp_enqueue_script functions
* updated flexlider, html5shiv and Genericons
* fixed three column post layout on search and archive pages
...
Maxwell WordPress Theme, Copyright 2016 ThemeZee.com
...
Maxwell bundles the following third-party resources:
