	  ...
	  ?>
        <?php if (is_home()) : ?><h1<?php else : ?><p<?php endif; ?> class="siteTitle__logo">
          <a class="siteTitle__link" href="<?php echo home_url() ?>">
            <?php if($myAmp){echo '<amp-img layout="responsive"';}else{echo '<img';} ?> src="<?php echo $logo;?>" class="siteTitle__img" alt="<?php bloginfo('name') ?>" width="<?php echo $logo_width;?>" height="<?php echo $logo_height;?>" ><?php if($myAmp){echo '</amp-img>';}?>
          </a>
