...
.comments__list .comment-meta{background:'.$primaryColor.';}
...
.content a:hover,
.t-light .l-footer{border-color:'.$primaryColor.';}
...
.related__title{color:'.$primaryColor.';}'."\n";
	}
...
function fit_admin_style() {
	...
	.edit-tags-php #tag-description + p::after{
		display: block;
		content: "※LION MEDIA Themeでは、Meta DescriptionとカテゴリTOP説明文に反映されます。";
		color: '.$cautionColor.';
	}
	</style>'."\n";
}
...
class Popular_Posts extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ($title) {
			...
			echo $before_title .'RANKING'. $after_title;
		}
		...
		?>
          <li class="rankListWidget__item">
            ...
            <div class="dateList dateList-widget">
              ...
              <span class="dateList__item icon-folder"><a class="hc<?php if (isset($cat_meta[$cat_id])) { echo esc_html($cat_meta[$cat_id]);} ?>" href="<?php echo $cat_link; ?>" rel="category"><?php echo $cat_name; ?></a></span>
            </div>
          </li>
