...
if (get_fit_amp_logo()) {
	...
	$amp_logo_size = getimagesize($amp_logo);
	$amp_logo_width = $amp_logo_size[0];
	$amp_logo_height = $amp_logo_size[1];
}
// ロゴ画像からサイズを取得
if (get_fit_image_logo()) {
	$image_logo = get_fit_image_logo();
	$image_logo_size = getimagesize($image_logo);
	$image_logo_width = $image_logo_size[0];
	$image_logo_height = $image_logo_size[1];
}
...
<?php fit_breadcrumb(); ?>
  ...
  <div class="l-wrapper">
    ...
    <?php endif; ?>">
      ...
      <iframe src="https://rcm-fe.amazon-adsystem.com/e/cm?o=9&p=48&l=ur1&category=primeday&banner=0JG5EB0Y1M4YZD8Q03G2&f=ifr&linkID=72e02d65a6daa39549f3511fb8b2776d&t=symfony0819-22&tracking_id=symfony0819-22" style="width:728px; height:90px; border:none;" scrolling="no" marginwidth="0" style="border:none;" frameborder="0"></iframe>
	    <?php the_content(); ?>
      </section>
	  <?php endwhile; endif; ?>
  ...
  "publisher": {
	  ...
	  "logo": {
		  ...
		  "width": "<?php echo($amp_logo_width); ?>",
		  "height":"<?php echo($amp_logo_height); ?>"
		  <?php else: // 通常?>
		    <?php if(get_fit_image_logo()): ?>
		    "url": "<?php echo get_fit_image_logo(); ?>",
		    "width": "<?php echo($image_logo_width); ?>",
		    "height":"<?php echo($image_logo_height);?>"
		    <?php else:?>
		    "url": "<?php echo get_fit_amp_logo(); ?>",
		    "width": "<?php echo($amp_logo_width); ?>",
		    "height":"<?php echo($amp_logo_height);?>"
